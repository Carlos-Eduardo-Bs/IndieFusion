...
namespace Indie.Controllers
{
    public class ClassificationsController : Controller
    {
        ...
        public ClassificationsController(IndieFusionFinalContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Classification.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Description")] Classification classification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description")] Classification classification)
        {
